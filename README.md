...
使其支持 NeoForge 1.21.x 往上的版本（截止 2025.10.20，原作者已经更新至 1.21.1）。
...
This is an unofficial remake of **[Witch's Broom]**. While it reuses the original assets, the code has been refactored to support NeoForge 1.21.x and above.
(As of Oct. 20, 2025, the original author has also updated the mod to 1.21.1.)
